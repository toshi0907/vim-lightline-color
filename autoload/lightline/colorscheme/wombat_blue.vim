" =============================================================================
" Filename: autoload/lightline/colorscheme/wombat_blue.vim
...
let s:p.tabline.tabsel = [ [ s:my_white, s:my_black ] ]
let s:p.tabline.middle = [ [ s:my_fground, s:my_bground ] ]
let s:p.tabline.right = [ [ s:my_fground, s:my_bground ] ]
let s:p.normal.error = [ [ s:base03, s:red ] ]
let s:p.normal.warning = [ [ s:base023, s:yellow ] ]

let g:lightline#colorscheme#wombat_blue#palette = lightline#colorscheme#flatten(s:p)
