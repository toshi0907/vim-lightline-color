" =============================================================================
" Filename: autoload/lightline/colorscheme/wombat_red.vim
...
let g:lightline#colorscheme#wombat_red#palette = lightline#colorscheme#flatten(s:p)
